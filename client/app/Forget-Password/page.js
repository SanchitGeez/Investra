...
const Forget = () => {
    ...
    const handleEmailSubmit = (e)=>
    {
        ...
        else
        {
            ...
            axios.post("https://investra-26xe.vercel.app/send-otp",{email:email})
            .then((response) => {
                setShowblock(true);
    ...
    const handleOTPSubmit =(e)=>
        {
            ...
            else
            {
                ...
                axios.post("https://investra-26xe.vercel.app/verify-otp",{email:email,otp:otp})
                .then((response) => {
                    toast.success(response.data, {
                        position: "top-center",
                        autoClose: 5000,
    ...
    const handlePasswordSubmit =(e)=>
    {
        ...
        else
        {
            ...
            axios.post("https://investra-26xe.vercel.app/change-password",{email:email,password:password})
            .then((response) => {
                toast.success(response.data, {
                    position: "top-center",
                    autoClose: 5000,
