            ...
            <div className="topbar">
                ...
                <Popover.Root>
                    <Popover.Trigger asChild>
                        <button className='balance-button text-black letter-space cursor-pointer'>+ BALANCE</button>
                    </Popover.Trigger>
                    <Popover.Portal>
                        <Popover.Content className="PopoverContent" sideOffset={5}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <fieldset className="Fieldset">
                                    ...
                                    <button className='balance-add-button cursor-pointer' onClick={handleBalanceAdd}>ADD</button>
                                </fieldset>
                    ...
                    <button className='logout-button letter-space cursor-pointer' onClick={handleLogout}>LOGOUT</button>
                </div>
            </div>
                ...
                <div className="left-side">
                    ...
                    <div className="balance-buy">
                        ...
                        <div className="buy-stocks">
                            ...
                            <button className='buy-confirm cursor-pointer' onClick={handlePurchase}>CONFIRM</button>
                        </div>
                    </div>
                </div>
